...
(define (valid-response e::HttpExchange match)
    (let* ( (rulestr (match 1)) (seedstr (match 2))
            ...
            ;(datatable (list (table-of-bitvector-list (calculate-grid rulenum (ensure-minimum-length (bitvector-of-int seednum) 100) 50))))
            (datatable (list (table-of-bitvector-list (calculate-grid rulenum (ensure-minimum-length (bitvector-of-binstring seedstr) 100) 50))))
        )
