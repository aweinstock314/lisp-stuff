...
(define *main-window-matrix*::PMVMatrix #!null)
...
;        (display proj-matrix) (newline)
    ...
    (define-constant (draw-whole-area gl2)
    ...
    (define-constant (draw-shipview gl2)
    ...
    (define-constant (draw-debugging-poly gl2)
    ...
    (gl2:glViewport 0 0 +screen-width+ +screen-height+)
    (draw-whole-area gl2)
    (gl2:glViewport 0 0 (/ +screen-width+ 2) (/ +screen-height+ 2))
    (draw-debugging-poly gl2)
)
...
(define (mousecoords->objcoords x y)
    ...
    (*main-window-matrix*:gluUnProject x (- +screen-height+ y) 0 (int[] 0 0 +screen-width+ +screen-height+) 0 output 0)
