...
(jf:setLayout #!null)
(initialize-label jf *game-state*:scorelabel 0 0)
(initialize-label jf *game-state*:liveslabel (- +window-width+ (+label-dimensions+:getWidth)) 0)
(initialize-label jf *game-state*:levellabel (- +window-width+ (+label-dimensions+:getWidth)) (+label-dimensions+:getHeight))
