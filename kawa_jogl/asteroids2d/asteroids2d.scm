...
(define-simple-class game-state ()
    ...
    (player-controls::input-controls (input-controls 'VK_LEFT 'VK_RIGHT 'VK_UP 'VK_DOWN 'VK_SPACE))
    ;(player-controls::input-controls (input-controls 'VK_A 'VK_D 'VK_W 'VK_S 'VK_1))
...
(define (event-loop gs::game-state is::interface-state)
    ...
    (invoke gs:player-controls 'process is:currently-held-keys gs:player-ship gs)
