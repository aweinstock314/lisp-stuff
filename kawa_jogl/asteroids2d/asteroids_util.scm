...
;    (display m2) (newline)
    ...
    (with-partial-evaluation (+ *) (float[] length: 4
        (* (m2 0) (+ (m1 (+ (* 0 4) 0)) (m1 (+ (* 1 4) 0)) (m1 (+ (* 2 4) 0)) (m1 (+ (* 3 4) 0))))
        (* (m2 1) (+ (m1 (+ (* 0 4) 1)) (m1 (+ (* 1 4) 1)) (m1 (+ (* 2 4) 1)) (m1 (+ (* 3 4) 1))))
        (* (m2 2) (+ (m1 (+ (* 0 4) 2)) (m1 (+ (* 1 4) 2)) (m1 (+ (* 2 4) 2)) (m1 (+ (* 3 4) 2))))
        (* (m2 3) (+ (m1 (+ (* 0 4) 3)) (m1 (+ (* 1 4) 3)) (m1 (+ (* 2 4) 3)) (m1 (+ (* 3 4) 3))))
    ))
)
